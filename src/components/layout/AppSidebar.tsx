import { LayoutDashboard, TrendingUp, Newspaper, Database, Settings, Bell, User, BarChart3, ClipboardList, History } from "lucide-react";
...
const menuItems = [
  ...
  { title: "My Trades", url: "/trades", icon: History },
